...
public final class AdobeAdeptNetProvider
  ...
  public AdobeAdeptStreamType newStream(
    ...
    final AdobeAdeptStreamClientType client,
    final String post_data_content_type,
  ...
  private static final class Stream implements AdobeAdeptStreamType {
    ...
    public Stream(
      ...
      final AdobeAdeptStreamClientType in_client,
      final AtomicInteger in_recursion,
      final PostData in_post_data,
    ...
    @Override
    public void onSetStreamClient(
      final AdobeAdeptStreamClientType c) {
