...
public final class AdobeAdeptConnectorFactory
  ...
  static {
    LOG = Objects.requireNonNull(LoggerFactory.getLogger(AdobeAdeptConnectorFactory.class));
  ...
  @Override
  public AdobeAdeptConnectorType get(
    ...
    try {
      ...
      @SuppressWarnings("unchecked") final Class<? extends AdobeAdeptConnectorType> c =
